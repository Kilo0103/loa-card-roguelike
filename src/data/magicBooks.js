export const MAGIC_BOOK_LIBRARY = Object.freeze({
  ...
  adrenaline: { number: 2, id: "adrenaline", name: "아드레날린", source: "loa", implemented: true, description: "이번 턴 실제 사용 코스트에 따라 다음 턴 공격 피해 +1/+2/+3. 3코스트 이상 사용 시 +3." },
  mass_increase: { number: 3, id: "mass_increase", name: "질량 증가", source: "loa", implemented: true, description: "모든 공격 카드 기본 코스트 +1, 공격 피해 +2." },
  crisis_evasion: { number: 4, id: "crisis_evasion", name: "위기 모면", source: "loa", implemented: true, description: "전투당 1회 치명 피해를 받으면 HP 1로 생존하고 발동 직전 HP만큼 보호막을 얻은 뒤 랜덤 마법서 1권이 파괴됩니다." },
  ...
  keen_combat_sense: { number: 15, id: "keen_combat_sense", name: "예리한 전투 감각", source: "original", implemented: true, description: "직전 턴에 사용하지 않은 종류의 카드 코스트 -1. 전투 첫 턴에는 적용되지 않습니다." },
  ...
  thorns: { number: 40, id: "thorns", name: "가시", source: "original", implemented: true, exclusiveGroup: "first_debuff_response", description: "전투 중 처음 받은 디버프를 부여한 적에게 동일한 종류·수치·지속시간으로 반사합니다." },
