export const MAGIC_BOOK_LIBRARY = Object.freeze({
  ...
  endless_nightmare: { number: 18, id: "endless_nightmare", name: "끝없는 악몽", source: "original", implemented: false, description: "턴 종료 코스트 조건에 따라 다음 턴 첫 카드/공격 강화." },
  ...
  escape_master: { number: 25, id: "escape_master", name: "탈출의 명수", source: "original", implemented: false, description: "보스 외 전투에서 보상을 포기하고 이탈." },
  ...
  mana_echo: { number: 29, id: "mana_echo", name: "마력 잔향", source: "original", implemented: false, description: "코스트 3 이상 유지 5턴 후 3턴 동안 현재 코스트 최저값 3." },
  ...
  fixed_memory: { number: 33, id: "fixed_memory", name: "기억 고정", source: "original", implemented: false, description: "턴 종료 시 손패 1장을 골라 보존." },
  contingency_plan: { number: 34, id: "contingency_plan", name: "예비 계획", source: "original", implemented: false, description: "전투 시작 2장 추가 드로우 후 2장 선택 버림." },
  ...
  recycling: { number: 36, id: "recycling", name: "재활용", source: "original", implemented: false, description: "전투 중 처음 소멸되는 카드 1장을 버림 더미로 이동." },
  ...
  cleanse_instinct: { number: 41, id: "cleanse_instinct", name: "정화 본능", source: "original", implemented: false, exclusiveGroup: "first_debuff_response", description: "매 전투 처음 받는 디버프 1개 무효." },
  ...
  fate_reselection: { number: 50, id: "fate_reselection", name: "운명의 재선택", source: "original", implemented: false, description: "카드 보상 랜덤 슬롯 1회 재추첨." },
});
